...
function ConvexAuthWrapper({ convex, children }: { convex?: ConvexReactClient; children: React.ReactNode }) {
  if (convex) return <ConvexAuthProvider client={convex}>{children}</ConvexAuthProvider>;
  return <>{children}</>;
}
